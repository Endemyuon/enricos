...
export const EmailVerification = ({ userName, verificationLink }: EmailVerificationProps) => {
  return (
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto', backgroundColor: '#ffffff', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ padding: '30px 20px' }}>
          ...
          <p style={{ color: '#4b5563', fontSize: '16px', lineHeight: '1.6' }}>
            Thank you for signing up at <strong>Enrico's Restaurant</strong>! To complete your registration and start earning loyalty points, please verify your email address.
          </p>
          ...
          <div style={{ backgroundColor: '#fef2f2', border: '1px solid #fee2e2', borderRadius: '6px', padding: '15px', marginTop: '25px', marginBottom: '25px' }}>
            <p style={{ color: '#b91c1c', fontSize: '14px', margin: '0' }}>
              ⏱️ <strong>This link will expire in 24 hours.</strong> If you didn't create this account, please ignore this email.
            </p>
          </div>

          <h3 style={{ color: '#1f2937', marginTop: '30px' }}>Why Verify?</h3>
